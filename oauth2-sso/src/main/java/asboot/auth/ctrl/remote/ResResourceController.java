...
public class ResResourceController {
	...
	private static final String SERVICE = "http://oauth2.resource:8081";
	...
	public UserInfo getUserInfo() {
		return this.oAuth2RestTemplate.getForObject(SERVICE + "/user_info", UserInfo.class);
	}
	...
	public String hasAuthAdminActuator() throws IOException {
		return this.oAuth2RestTemplate.getForObject(SERVICE + "/actuator", String.class);
	}
